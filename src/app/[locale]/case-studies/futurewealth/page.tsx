...
function ProjectDescriptionSection() {
  const t = useTranslations('caseStudies.futurewealth.description');
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative">
            <div className="bg-gray-100 rounded-lg p-8">
              <Image
                src="/images/case-studies/futurewealth-chat.jpg"
                alt="Future Wealth Group AI Chat Interface"
                width={600}
                height={400}
...
function CTASection() {
  const t = useTranslations('caseStudies.futurewealth.hero');

  return (
    <Section className="py-20 bg-accent">
      <div className="max-w-4xl mx-auto text-center">
        <h2 className="text-3xl lg:text-4xl font-bold text-white mb-4 font-heading">
          Bereit, Ihr KI-Wissenssystem aufzubauen?
        </h2>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          ...
          <Button 
            href="https://futurewealthgroup.ch" 
            variant="outline" 
            size="lg"
...
export default function FutureWealthCaseStudy() {
  return (
    <>
      <HeroSection ns="caseStudies.futurewealth.hero" videoSrc="/videos/futurewealth-bg.mp4" />
