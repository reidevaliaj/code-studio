...
function ProjectDescriptionSection() {
  const t = useTranslations('caseStudies.econext.description');
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative">
            <div className="bg-gray-100 rounded-lg p-8">
              <Image
                src="/images/case-studies/econext-dashboard.jpg"
                alt="E-Connext Job Scraping Dashboard"
                width={600}
                height={400}
...
function CTASection() {
  const t = useTranslations('caseStudies.econext.hero');

  return (
    <Section className="py-20 bg-accent">
      <div className="max-w-4xl mx-auto text-center">
        <h2 className="text-3xl lg:text-4xl font-bold text-white mb-4 font-heading">
          Bereit, Ihre Datenintelligenz-Plattform aufzubauen?
        </h2>
...
export default function EConnextCaseStudy() {
  return (
    <>
      <HeroSection ns="caseStudies.econext.hero" videoSrc="/videos/econext-bg.mp4" />
