...
function WhatWeDoSection() {
  const t = useTranslations('serviceDetails.webApps.whatWeDo');
...
function HowItWorksSection() {
  const t = useTranslations('serviceDetails.webApps.howItWorks');
...
function TechnologiesSection() {
  const t = useTranslations('serviceDetails.webApps.technologies');
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-6 gap-4">
          {t.raw('techs').map((tech: string, index: number) => (
            <div key={index} className="bg-gray-50 p-4 rounded-lg text-center shadow-sm hover:shadow-md transition-shadow">
...
function ResultsSection() {
  const t = useTranslations('serviceDetails.webApps.results');
...
function CTASection() {
  const t = useTranslations('serviceDetails.webApps.cta');
...
export default function WebAppsPage() {
  return (
    <>
      <HeroSection ns="serviceDetails.webApps.hero" imageSrc="/images/webaplication.jpg" />
      <WhatWeDoSection />
      <HowItWorksSection />
      <TechnologiesSection />
      <ResultsSection />
