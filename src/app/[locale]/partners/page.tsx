...
export const metadata: Metadata = {
  title: 'Partner mit Code Studio - Internationale Webentwicklungspartnerschaft',
  description: 'Werden Sie Code Studio-Partner und profitieren Sie von professionellen Webentwicklungsdienstleistungen zu wettbewerbsfähigen Preisen aus Albanien.',
  keywords: 'webentwicklung partner, albanien entwicklung, internationale partnerschaft, web agentur partner',
  openGraph: {
    title: 'Partner mit Code Studio - Internationale Webentwicklungspartnerschaft',
    description: 'Werden Sie Code Studio-Partner und profitieren Sie von professionellen Webentwicklungsdienstleistungen zu wettbewerbsfähigen Preisen aus Albanien.',
    type: 'website',
            ...
            <form className="space-y-6">
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-accent focus:border-transparent font-sans"
                >
                  <option value="">Dienstleistungen auswählen</option>
                  <option value="web-development">Webentwicklung</option>
                  <option value="web-design">Webdesign</option>
                  <option value="wordpress">WordPress-Entwicklung</option>
                  <option value="shopify">Shopify-Entwicklung</option>
                  <option value="ai-automation">KI-Automatisierung</option>
  ...
  return (
    <div className="relative w-[400px] h-[300px] md:w-[450px] md:h-[350px]">
      ...
      <div className="relative w-full h-full rounded-2xl overflow-hidden">
        <Image
          src={imageSrc}
          alt="Partnerschaft mit Code Studio"
          width={450}
          height={350}
