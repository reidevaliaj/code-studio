    ...
    <Section className="py-16 bg-gray-100">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <p className="text-lg text-gray-600 mt-4 font-sans">
          Wählen Sie die Option, die für Sie am besten funktioniert
        </p>
      </div>
    </Section>
  );
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-6">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h4 className="font-semibold text-gray-900 font-sans">Adresse</h4>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h4 className="font-semibold text-gray-900 font-sans">Telefon</h4>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h4 className="font-semibold text-gray-900 font-sans">E-Mail</h4>
