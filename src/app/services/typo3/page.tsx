...
function WhatWeDoSection() {
  const t = useTranslations('serviceDetails.typo3.whatWeDo');
...
function PortfolioSection() {
  const t = useTranslations('serviceDetails.typo3.portfolio');
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mt-12">
          <p className="text-lg text-gray-600 font-sans">
            <span className="font-bold text-accent">150+</span> TYPO3 projects delivered successfully
          </p>
        </div>
      </div>
    </Section>
...
function TechnologiesSection() {
  const t = useTranslations('serviceDetails.typo3.technologies');
...
function ExpectationsSection() {
  const t = useTranslations('serviceDetails.typo3.expectations');
...
function CTASection() {
  const t = useTranslations('serviceDetails.typo3.cta');
...
export default function TYPO3Page() {
  return (
    <>
      <Header />
      <main className="min-h-screen">
        <HeroSection ns="serviceDetails.typo3.hero" imageSrc="/images/typo3.jpg" />
        <WhatWeDoSection />
        <PortfolioSection />
        <TechnologiesSection />
        <ExpectationsSection />
