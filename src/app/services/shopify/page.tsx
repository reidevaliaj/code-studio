...
function WhatWeDoSection() {
  const t = useTranslations('serviceDetails.shopify.whatWeDo');
...
function PortfolioSection() {
  const t = useTranslations('serviceDetails.shopify.portfolio');
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mt-12">
          <p className="text-lg text-gray-600 font-sans">
            <span className="font-bold text-accent">150+</span> Shopify stores delivered successfully
          </p>
        </div>
      </div>
    </Section>
...
function TechnologiesSection() {
  const t = useTranslations('serviceDetails.shopify.technologies');
...
function ExpectationsSection() {
  const t = useTranslations('serviceDetails.shopify.expectations');
...
function CTASection() {
  const t = useTranslations('serviceDetails.shopify.cta');
  ...
  return (
    <>
      ...
      <main className="min-h-screen">
        <HeroSection ns="serviceDetails.shopify.hero" imageSrc="/images/shopify.jpg" />
        <WhatWeDoSection />
        <PortfolioSection />
        <TechnologiesSection />
        <ExpectationsSection />
