...
function WhatWeDoSection() {
  const t = useTranslations('serviceDetails.wordpress.whatWeDo');
...
function PortfolioSection() {
  const t = useTranslations('serviceDetails.wordpress.portfolio');
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mt-12">
          <p className="text-lg text-gray-600 font-sans">
            <span className="font-bold text-accent">150+</span> WordPress websites delivered successfully
          </p>
        </div>
      </div>
    </Section>
...
function TechnologiesSection() {
  const t = useTranslations('serviceDetails.wordpress.technologies');
...
function ExpectationsSection() {
  const t = useTranslations('serviceDetails.wordpress.expectations');
...
function CTASection() {
  const t = useTranslations('serviceDetails.wordpress.cta');
  ...
  return (
    <>
      ...
      <main className="min-h-screen">
        <HeroSection ns="serviceDetails.wordpress.hero" imageSrc="/images/wordpress.jpg" />
        <WhatWeDoSection />
        <PortfolioSection />
        <TechnologiesSection />
        <ExpectationsSection />
